...
func (e *Engine) SetExecuterHostOptions(host string) {
	//e.executerOpts.Options.CustomHeaders=goflags.StringSlice{"Host: " + host}
	e.executerOpts.Options.CustomHeaders = append(e.executerOpts.Options.CustomHeaders, host)
}
